...
- **Activity Process Guides** = user-facing step-by-step activity workflows, including Customer-visible evidence updates, controlled claim/release/handoff ownership flows, internal note vs Customer-visible update guidance, and Customer ticket resolution.
