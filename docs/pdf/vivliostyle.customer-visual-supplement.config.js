...
const publicationTitle =
  "ERPNext / Helpdesk Pilot Customer Activity Process Guides Visual Supplement";
...
export default defineConfig({
  ...
  entry: [
    {
      path: "pdf/dist/customer-activity-process-guides-visual-supplement.md",
      title: "Customer Activity Process Guides Visual Supplement",
    },
  ],
  ...
  workspaceDir: "dist/.vivliostyle-customer-visual-supplement",
  output: "dist/customer-activity-process-guides-visual-supplement.pdf",
});
