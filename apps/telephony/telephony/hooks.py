...

    {
        ...
        "filters": [
            ["name", "in", [
                ...
                "HD Ticket-custom_ownership_model",
                "HD Ticket-custom_severity",
                "HD Ticket-custom_affected_equipment",
                "HD Ticket-custom_equipment_ref",
                "HD Ticket-custom_section_break_n0d4t",
                "HD Ticket-custom_service_area",
                "HD Ticket-custom_fulfilment_party",
                "HD Ticket-custom_fulfilment_partner",
                "HD Ticket-custom_request_type",
                "HD Ticket-custom_due_date",
                "HD Ticket-custom_request_source",
                ...
                "HD Ticket-custom_partner_acceptance_state",
                "HD Ticket-custom_partner_accepted_on",
                ...
                "Location-custom_kmz_folder_path",
                "Location-custom_kmz_geometry_type",
                ...
                "Location-custom_ticket_selectability",
                "Location-custom_first_seen_import",
                "Location-custom_last_seen_import",
                "Location-custom_last_changed_import",
            ]],
        ],
    },
...
doc_events["HD Ticket"]["validate"] = [
    ...
    "telephony.telectro_equipment_guard.validate_affected_equipment",
...
for p in [
    "/assets/telephony/js/telectro_home_redirect.js?v=2026-05-20-2",
    ...
    "/assets/telephony/js/telectro_handoff_action.js?v=2026-06-09-1",
     "/assets/telephony/js/customer_resolution_action.js?v=2026-06-04-1",
